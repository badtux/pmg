...
class Sanitizer {
	...
	public static function getInstance() {
		if(!self::$instance instanceof Sanitizer) {
	...
	public function clean($str,$is_image=false) {
		...
		*/
		do {
			...
			if (preg_match('/<a/i', $str) && function_exists('_js_link_removal')) {
				$str = preg_replace_callback('#<a\s+([^>]*?)(?:>|$)#si', array($this, '_js_link_removal'), $str);
			}

			if (preg_match('/<img/i', $str) && function_exists('_js_img_removal')) {
 ...
 */
	...
	protected function _remove_evil_attributes($str, $is_image) {
		...
		$evil_attributes = array( /* 'on\w*', */'onload','onclick','onmouseover','onmousemove','onmouseup','onmousedown','onmouseout','onmousewheel','onscroll','ondrag'
				, 'style', 'xmlns', 'formaction');
